...
<?php
        ...
        <div class="tab-content" id="help-tab" style="display: none;">
            ...
            <div class="help-section">
                ...
                <div class="help-steps">
                    <div class="help-step">
                        ...
                        <p><?php echo esc_html__('Go to Basic Settings and select either OpenAI or Claude as your AI provider.', 'wp-ai-explainer'); ?></p>
                    </div>
                    
                    <div class="help-step">
                        <h4><?php echo esc_html__('2. Add Your API Key', 'wp-ai-explainer'); ?></h4>
                        <p><?php echo esc_html__('Enter your API key from your chosen provider. Your key is encrypted and secure.', 'wp-ai-explainer'); ?></p>
                        <ul>
                    ...
                    <div class="help-step">
                        ...
                        <p><?php echo esc_html__('Choose the AI model that best fits your needs and budget.', 'wp-ai-explainer'); ?></p>
                        <ul>
                    ...
                    <div class="help-step">
                        ...
                        <p><?php echo esc_html__('Use the "Test API Key" button to verify your setup, then save your settings.', 'wp-ai-explainer'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="help-section">
                ...
                <div class="help-usage">
                    <ol>
                        <li><?php echo esc_html__('Users select any text on your website', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('A floating toggle button appears to enable explanations', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('When enabled, users can select text to get instant AI explanations', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Explanations appear in responsive tooltips that users can dismiss', 'wp-ai-explainer'); ?></li>
                    </ol>
                </div>
            </div>
            ...
            <div class="help-section">
                ...
                <div class="help-feature">
                    ...
                    <ul>
                        <li><?php echo esc_html__('Customise tooltip colours (background, text, and footer text) to match your theme', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Position the toggle button where it works best', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Add disclaimers and provider attribution in tooltip footers', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Control footer text color independently for optimal visibility', 'wp-ai-explainer'); ?></li>
                    </ul>
                </div>
                ...
                <div class="help-feature">
                    ...
                    <ul>
                        <li><?php echo esc_html__('Control minimum and maximum text selection lengths', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Include/exclude specific page elements with CSS selectors', 'wp-ai-explainer'); ?></li>
                        <li><?php 
                        // translators: {{snippet}} is a placeholder that will be replaced with the user's selected text
                ...
                <div class="help-feature">
                    ...
                    <ul>
                        <li><?php echo esc_html__('Enable caching to reduce API costs and improve speed', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Set rate limits to prevent abuse and control usage', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Configure different limits for logged-in vs anonymous users', 'wp-ai-explainer'); ?></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="help-section">
                ...
                <div class="help-troubleshooting">
                    <div class="help-issue">
                        ...
                        <ul>
                            <li><?php echo esc_html__('Check that the plugin is enabled in Basic Settings', 'wp-ai-explainer'); ?></li>
                            <li><?php echo esc_html__('Verify your API key is entered correctly', 'wp-ai-explainer'); ?></li>
                            <li><?php echo esc_html__('Test your API key using the "Test API Key" button', 'wp-ai-explainer'); ?></li>
                            <li><?php echo esc_html__('Enable Debug Mode in Advanced tab for detailed logs', 'wp-ai-explainer'); ?></li>
                        </ul>
                    </div>
                    
                    <div class="help-issue">
                        <h4><?php echo esc_html__('High API costs?', 'wp-ai-explainer'); ?></h4>
                        <ul>
                            <li><?php echo esc_html__('Enable caching in Performance settings', 'wp-ai-explainer'); ?></li>
                            <li><?php echo esc_html__('Set appropriate rate limits for your users', 'wp-ai-explainer'); ?></li>
                            <li><?php echo esc_html__('Consider using GPT-3.5-turbo or Claude-haiku for lower costs', 'wp-ai-explainer'); ?></li>
                            <li><?php echo esc_html__('Adjust text length limits to control prompt size', 'wp-ai-explainer'); ?></li>
                        </ul>
                    </div>
                    
                    <div class="help-issue">
                        <h4><?php echo esc_html__('Tooltip positioning issues?', 'wp-ai-explainer'); ?></h4>
                        <ul>
                            <li><?php echo esc_html__('The plugin automatically handles positioning and viewport boundaries', 'wp-ai-explainer'); ?></li>
                            <li><?php echo esc_html__('Check Content Rules for conflicting CSS selectors', 'wp-ai-explainer'); ?></li>
                            <li><?php echo esc_html__('Ensure your theme doesn\'t override plugin styles', 'wp-ai-explainer'); ?></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="help-section">
                ...
                <div class="help-costs">
                    <ul>
                        <li><?php echo esc_html__('Start with caching enabled and conservative rate limits', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Monitor your API usage in your provider\'s dashboard', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Set usage alerts in your API provider account', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Consider shorter custom prompts to reduce token usage', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Use appropriate models: faster models are typically cheaper', 'wp-ai-explainer'); ?></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="tab-content" id="support-tab" style="display: none;">
            ...
            <div class="support-section">
                ...
                <div class="support-options">
                    <div class="support-option">
                        ...
                        <p><?php echo esc_html__('Start with the Help tab above for common setup and troubleshooting guides.', 'wp-ai-explainer'); ?></p>
                    </div>
                    
                    <div class="support-option">
                        <h4><?php echo esc_html__('2. Enable Debug Mode', 'wp-ai-explainer'); ?></h4>
                        <p><?php echo esc_html__('Turn on Debug Mode in Advanced settings to see detailed error logs.', 'wp-ai-explainer'); ?></p>
                    </div>
                    
                    <div class="support-option">
                        <h4><?php echo esc_html__('3. GitHub Issues', 'wp-ai-explainer'); ?></h4>
                        <p><?php echo esc_html__('Report bugs or request features at', 'wp-ai-explainer'); ?> <a href="https://github.com/billymedia/wp-explainer/issues" target="_blank">github.com/billymedia/wp-explainer/issues</a></p>
                    </div>
                    
                    <div class="support-option">
                        <h4><?php echo esc_html__('4. Custom Modifications', 'wp-ai-explainer'); ?></h4>
                        <p><?php echo esc_html__('For custom modifications or professional services, contact Billy directly at billy@billymedia.co.uk', 'wp-ai-explainer'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="support-section">
                ...
                <div class="support-info-needed">
                    <p><?php echo esc_html__('Please include the following information when requesting support:', 'wp-ai-explainer'); ?></p>
                    <ul>
            ...
            <div class="support-section">
                <h3><?php echo esc_html__('Contributing', 'wp-ai-explainer'); ?></h3>
                <div class="contributing-info">
                    <p><?php echo esc_html__('We welcome contributions to make this plugin better:', 'wp-ai-explainer'); ?></p>
                    <ul>
                        <li><?php echo esc_html__('Report bugs and suggest features on GitHub', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Submit pull requests for improvements', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Help with translations and internationalization', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Share feedback and usage experiences', 'wp-ai-explainer'); ?></li>
                        <li><?php echo esc_html__('Test new features and provide feedback', 'wp-ai-explainer'); ?></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="explainer-admin-actions">
        <h2><?php echo esc_html__('Quick Actions', 'wp-ai-explainer'); ?></h2>
        <p>
